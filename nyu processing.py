...
class NYUVP:
    ...
    def __init__(self, data_dir_path="C:/Users/Rabpreet/Desktop/nyu_vp-master/nyu_vp-master/data", split='all', keep_data_in_memory=True, mat_file_path=None,
        ...
        if mat_file_path is not None:
            ...
            #mat_file_path = "C:/Users/Rabpreet/Desktop/nyu_depth_v2_labeled.mat"
            #with h5py.File(mat_file_path, 'r') as mat_file:
                #images_data = mat_file['images']
    ...
    def __getitem__(self, key):
        ...
        if datum is None:
            ...
            if lsd_line_segments is None:
                ...
                print("lsd_line: ",len(self.lsd_line_files))
                print("vps: ",len(self.vps_files))
                print("label",len(self.labelled_line_files ))
            ...
            print("vps_pixel: ", vps_pixel.shape)
            vps_homo = np.vstack(vp_homo_list)
            print("vps_homo: ", vps_homo.shape)
...
if __name__ == '__main__':
    ...
    #parser.add_argument('--mat_file', default='C:/Users/Rabpreet/Desktop/nyu_vp-master/nyu_vp-master/nyu_depth_v2_labeled.v7.mat', help='mat_file')
    ...
    for idx in range(len(dataset)):
        ...
        for j in range(0, 4):
            ...
            if j == 0:
                ...
                print("enetr 5")
                #vpts_pixel_homogeneous = np.hstack([vpts_pixel, np.ones((3, 1))])
                #print("vpts_pixel_homogeneous: ",vpts_pixel_homogeneous.shape)
                #np.savez_compressed('output.npz', vpts_pixel_homogeneous=vpts_pixel_homogeneous, vpts_homo=vpts_homo, line_segments=line_segments)
                ...
                #np.savez_compressed(npz_name, line_segments=line_segments, labelled_lines=labelled_lines, vpts_pixel=vpts_pixel_homogeneous, vpts=vpts_homo)
                #np.savez_compressed(npz_name, line_segments=line_segments, labelled_lines=labelled_lines, vpts=vpts_homo)
            ...
            if j == 1:  # # # left-right
                ...
                labelled_line[2] *= -1.
                labelled_line[2] += image.shape[1]
                #labelled_lines_new = labelled_line
